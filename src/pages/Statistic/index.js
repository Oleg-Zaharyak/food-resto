  ...
  return (
    <div className={style.container}>
      ...
      <div className={style.content_container}>
        ...
        <div className={style.all_orders_wrap}>
          <div className={style.all_orders_container}>
            <div
              onClick={openTableClick}
              className={style.all_orders_up_container}
            >
              <div className={style.all_orders_text}>
                Відкрити табличку всіх ордерів
              </div>
              <svg
                className={style.all_orders_icon}
                width="24"
                height="24"
                viewBox="0 0 20 20"
                fill="currentColor"
                xmlns="http://www.w3.org/2000/svg"
                style={{ transform: `rotate(${openTable ? 180 : 0}deg)` }}
              >
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
            ...
            {openTable ? (
              <div className={style.all_order_report}>
